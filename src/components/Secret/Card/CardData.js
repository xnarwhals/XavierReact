...
const CardData = [
   {
      ...
      promptsFavorite: ["Anime", "Animal", "Pokemon Game", "Dessert", "Program Language", "Fruit" ],
   ...
   },
   {
      ...
      answersFavorite: ["Apartment 510!", "PS4", "Angry Chickz", "Endless Walking!", "Lebron James", "Fireship"],
