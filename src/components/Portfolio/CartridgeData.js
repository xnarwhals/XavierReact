...
const cartridgeData = [
    {
        id: "Selva",
        image: require ("../../assets/images/Game_Selva.png"),
        trailerUrl: "https://www.youtube.com/embed/h2abkQpf6_M?si=xefEiDqt4xxHcaRl", 
        backImg: require ("../../assets/images/SelvaBack.png"),
        frontImg: require ("../../assets/images/Selva.png"),
        colors: {
            mainColor: "#C1E899",
    ...
    {
        id: "Colorezz",
        image: require ("../../assets/images/Game_Colorezz.png"),
        trailerUrl: "https://www.youtube.com/embed/ULZr5-ryP3c?si=G7HqJ5HJ6TUoYi-v",
        backImg: require ("../../assets/images/ColorezzBack.png"),
        frontImg: require ("../../assets/images/Colorezz.png"),
        colors: {
            mainColor: "#219ebc",
    ...
    {
        id: "Apt510",
        image: require ("../../assets/images/Game_Apt510.png"),
        trailerUrl: "https://www.youtube.com/embed/jrzt0Dyz0MU?si=v5-pfKBY-LGzJQE3",
        backImg: require ("../../assets/images/VPVRBack.png"),
        frontImg: require ("../../assets/images/VPVR.png"),
        colors: {
            mainColor: "#7E5CAD",
